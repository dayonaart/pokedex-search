class PokemonSearchModel {
  ...
  PokemonSearchModel.fromJson(Map<String, dynamic> json) {
...
class Other {
  ...
  Other.fromJson(Map<String, dynamic> json) {
    ...
    officialArtwork =
        json['official-artwork'] != null ? new DreamWorld.fromJson(json['official-artwork']) : null;
  }
...
class GenerationIii {
  ...
  GenerationIii.fromJson(Map<String, dynamic> json) {
    emerald = json['emerald'] != null ? new Emerald.fromJson(json['emerald']) : null;
    fireredLeafgreen =
...
class GenerationIv {
  ...
  GenerationIv.fromJson(Map<String, dynamic> json) {
    diamondPearl =
        json['diamond-pearl'] != null ? new DiamondPearl.fromJson(json['diamond-pearl']) : null;
...
class GenerationVi {
  ...
  GenerationVi.fromJson(Map<String, dynamic> json) {
    omegarubyAlphasapphire = json['omegaruby-alphasapphire'] != null
        ...
        : null;
    xY = json['x-y'] != null ? new OmegarubyAlphasapphire.fromJson(json['x-y']) : null;
  }
...
class OmegarubyAlphasapphire {
  ...
  OmegarubyAlphasapphire(
      {this.frontDefault, this.frontFemale, this.frontShiny, this.frontShinyFemale});
