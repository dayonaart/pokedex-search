class EvolveModel {
  ...
  EvolveModel({this.chain, this.id});

  EvolveModel.fromJson(Map<String, dynamic> json) {
...
class EvolvesTo {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.evolutionDetails != null) {
      data['evolution_details'] = this.evolutionDetails.map((v) => v.toJson()).toList();
    }
    if (this.evolvesTo != null) {
      data['evolves_to'] = this.evolvesTo.map((v) => v.toJson()).toList();
    }
...
class EvolutionDetails {
  ...
  EvolutionDetails(
      {this.minLevel, this.needsOverworldRain, this.timeOfDay, this.trigger, this.turnUpsideDown});

  EvolutionDetails.fromJson(Map<String, dynamic> json) {
    minLevel = json['min_level'];
    needsOverworldRain = json['needs_overworld_rain'];
    timeOfDay = json['time_of_day'];
    trigger = json['trigger'] != null ? new Trigger.fromJson(json['trigger']) : null;
