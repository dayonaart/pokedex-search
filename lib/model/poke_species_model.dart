class PokeSpecies {
  ...
  PokeSpecies.fromJson(Map<String, dynamic> json) {
    baseHappiness = json['base_happiness'];
    captureRate = json['capture_rate'];
    pokeColor = json['color'] != null ? new PokeColor.fromJson(json['color']) : null;
    if (json['egg_groups'] != null) {
      eggGroups = <EggGroup>[];
      json['egg_groups'].forEach((v) {
        eggGroups.add(new EggGroup.fromJson(v));
      });
    }
    ...
    generation = json['generation'] != null ? new PokeColor.fromJson(json['generation']) : null;
    growthRate = json['growth_rate'] != null ? new PokeColor.fromJson(json['growth_rate']) : null;
    habitat = json['habitat'] != null ? new PokeColor.fromJson(json['habitat']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pokeColor != null) {
      data['color'] = this.pokeColor.toJson();
    }
    ...
    if (this.palParkEncounters != null) {
      data['pal_park_encounters'] = this.palParkEncounters.map((v) => v.toJson()).toList();
    }
    if (this.pokedexNumbers != null) {
      data['pokedex_numbers'] = this.pokedexNumbers.map((v) => v.toJson()).toList();
    }
    if (this.shape != null) {
...
class FlavorTextEntries {
  ...
  FlavorTextEntries.fromJson(Map<String, dynamic> json) {
    ...
    language = json['language'] != null ? new PokeColor.fromJson(json['language']) : null;
    version = json['version'] != null ? new PokeColor.fromJson(json['version']) : null;
  }
...
class PokedexNumbers {
  ...
  PokedexNumbers.fromJson(Map<String, dynamic> json) {
    ...
    pokedex = json['pokedex'] != null ? new PokeColor.fromJson(json['pokedex']) : null;
  }
...
class Varieties {
  ...
  Varieties.fromJson(Map<String, dynamic> json) {
    ...
    pokemon = json['pokemon'] != null ? new PokeColor.fromJson(json['pokemon']) : null;
  }
